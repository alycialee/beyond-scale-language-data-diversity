...
def main():
    ...
    training_args.output_dir = run_dir_path
    ...
    num_params_dict = {
        'num_params/all': model.num_parameters(only_trainable=False, exclude_embeddings=False),
        'num_params/trainable': model.num_parameters(only_trainable=True),
        'num_params/excluding_embeddings': model.num_parameters(exclude_embeddings=True),
    }
    ...
    #                  tokenizer,
    #                  results_name=model_args.eval_incontext_results,
    ...
    logger.info("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BEFORE TOKENIZED DATASETS")
    ...
    if model_args.generate_cache:
        ...
        return {}
    logger.info("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~BEFORE INIT TRAINER")
    ...
    # if model_args.eval_incontext:
    #     logger.info("*** Evaluate In-Context 2 ***")
    #     model.eval()
    #     eval_prompts(model,
    #                  Path(data_args.train_file).parent,
    #                  tokenizer,
